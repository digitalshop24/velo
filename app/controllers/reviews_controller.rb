class ReviewsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @review.save
        format.html { redirect_to @review, notice: 'Отзыв создан.' }
  ...
  def update
    respond_to do |format|
      if @review.update(review_params)
        format.html { redirect_to @review, notice: 'Отзыв обновлен.' }
  ...
  def destroy
    @review.destroy
    respond_to do |format|
      format.html { redirect_to reviews_url, notice: 'Отзыв сохранен.' }
