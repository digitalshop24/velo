class TubingsController < ApplicationController
  ...
  def tubing_params
    params.require(:tubing).permit(:video, :price, :old_price, :name, :manufacturer_id, :bottom_material, :top_material, :diameter, :handles_type, :tow_rope, :description, :display, :hit)
  end
end
